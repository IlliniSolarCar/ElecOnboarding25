...
Take a signal from the dash board to sound a horn
...
https://wiki.illinisolarcar.com/w/index.php/Public:Electrical_Onboarding_Fall_2025#Welcome_to_Illini_Solar_Car.21
...
Horn on/off signal from dashboard to determine when horn is sounded
