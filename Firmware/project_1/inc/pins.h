...
#define P_LED5 P0_4
// PROJECT 2 - Define potentiometer pin
#define P_POTENTIOMETER P0_1
/*
...
// PROJECT 1 - You can declare a DigitalOut object here - LED5 for Proj1
extern DigitalOut led5;
// PROJECT 2 - Declare AnalogIn object for potentiometer
